...
resource "aws_lambda_function" "web_lambda" {
  ...
  package_type  = "Image"
  image_uri     = "499781533590.dkr.ecr.us-east-1.amazonaws.com/test-lambda:master_d6f657"
...
resource "aws_lambda_function" "invoker_lambda" {
  ...
  package_type  = "Image"
  image_uri     = "499781533590.dkr.ecr.us-east-1.amazonaws.com/lambda-invoker:master_d6f657"
